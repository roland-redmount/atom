...
/**
 * Create a linked list with a single item (possibly 0)
 */
 ...
 * If freeItem() is 0, it is ignored
 */
 ...
 * If compare == 0, item pointers are compared directly
 ...
 * Takes address of list pointer, *list may be 0
