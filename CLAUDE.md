...
Documentation of code in comments is important, particularly for highly technical parts of the codebase, such as the compiler. The more conceptually difficult code is, the more thorough and explicit the documentation has to be. Yet, documentation strings should not be inserted everywhere just to be on the safe side: too much comments text become overwhelming. When writing comments:
