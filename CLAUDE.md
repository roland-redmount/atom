...
* Be brief, including only the necessary points. Don't reiterate documentation that is already present elsewhere; refer to it instead. Long, meandering documentation strings tend not to be read by users, and so is counter-productive.
